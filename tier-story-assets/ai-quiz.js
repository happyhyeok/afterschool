(() => {
  ...
  const questions = [
    {
      question: "AI에게 좋은 티어스토리를 부탁하려면 어떤 정보가 꼭 필요할까요?",
      options: [
        "캐릭터 이름만 있으면 된다",
        "캐릭터 이름, 능력, 약점, 성격, 티어 이유가 필요하다",
        "친구 이름과 학교 이름이 필요하다",
        "아무 설명 없이 부탁해도 된다"
      ],
      answer: 1,
    ...
    {
      question: "AI가 만든 티어스토리에 내 캐릭터의 약점이 빠졌습니다. 어떻게 해야 할까요?",
      options: [
        "그냥 저장한다",
      ...
      answer: 2,
      correct: "맞습니다. 강점과 약점이 함께 있어야 티어 이유가 더 설득력 있습니다.",
      incorrect: "강한 캐릭터도 약점이 있어야 더 재미있고 균형 잡힌 이야기가 됩니다."
    },
    {
      question: "티어스토리에 넣으면 안 되는 정보는 무엇일까요?",
      options: [
        "캐릭터 능력",
        "캐릭터 성격",
        "실제 친구의 이름, 전화번호, 주소",
    ...
    {
      question: "AI가 만든 티어스토리를 저장하기 전 확인할 내용으로 알맞은 것은 무엇일까요?",
      options: [
      ...
      answer: 3,
      correct: "맞습니다. 저장 전에는 이름, 능력, 약점, 티어 이유를 꼭 확인합니다.",
      incorrect: "저장 전에는 캐릭터 이름, 능력, 약점, 티어 이유를 모두 확인해야 합니다."
    }
  ];
  ...
  function renderFinish() {
    content.innerHTML = `
      <div class="ai-quiz-finish">
        <h3>퀴즈 완료!</h3>
        <p>좋아요! 이제 AI가 만든 티어스토리를 확인하고, 내 캐릭터에 맞는지 점검해 봅시다.</p>
